...
import id from './languages/idn.json';
...
function App() {
  ...
  const [lang, setLang] = useState(() => {
    ...
    // checks the browser default settings
  ...
  return (<>
    ...
    <div className="relative" >
      ...
      <Canvas className="" dpr={[1, 2]} style={{ height: "100vh", position: "fixed", background: "#e187c0", touchAction: "pan-y" }}
        ...
        <Scene positionofxz={positionofxz} setpositionofxz={setpositionofxz} cameraBusy={cameraBusy} focusObject={focusObject} setFocusObject={setFocusObject} activeDiv={activeDiv} zoomedin={zoomedin} setZoomedin={setZoomedin} tutorial={tutorial} setTutorial={setTutorial} text={text} />
