export function Warning({ setWarning, text }) {
    ...
    return (<div>
        ...
        <div className="fixed z-20 flex flex-col bg-green-400 toolbar justify-center items-center text-center px-4 py-4" style={{ width: "300px", height: "400px", top: "50%", left: "50%", transform: "translate(-50%,-50%)", fontSize: "23px" }}>
            <p className="mx-6 mt-2">{text.warningText}</p>
            <div className="mt-12 bg-red-100 rounded-xl px-2 py-2 border-black border-2 cursor-pointer" onClick={() => setWarning(false)}>{text.warningButton}</div>
        </div>
    </div>)
