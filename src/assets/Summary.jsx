export function Summary({ animateCamera, cameraBusy, originalCameraPosition, originalLookAt, camera, positionofxz, setZoomedin, zoomedin, text }) {
    return (
        <div className={` grid bg-green-200`} style={{ width: "100%", height: "100%", pointerEvents: zoomedin ? "auto" : "none" }}>
            ...
            <div className="relative z-20 mx-4 ">
                <div className="flex mx-4">
                    <div className=" md:text-5xl pt-4 md:pt-6" style={{ fontWeight: "600", letterSpacing: "-1px", fontSize: "50px" }}>{text.greeting}</div>
                ...
                <div className="mt-4 md:mt-6 mx-4 md:mx-10 text-lg md:text-2xl">
                    <div className="" style={{ fontSize: "23px" }}>{text.summary}</div>
                    <div className="mt-4 md:mt-6 " style={{ fontSize: "24px" }}><span className="font-bold">{text.techStackLabel}</span>   {text.techStack}</div>
                    <div className="mt-4  md:pb-4" style={{ fontSize: "24px" }}><span className="font-bold">{text.otherSkillsLabel}</span>   {text.otherSkills}</div>
                </div>
            </div>
